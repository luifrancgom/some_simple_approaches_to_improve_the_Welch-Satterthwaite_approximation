...
tbl-sim-pro-rel-alpha-005 and tbl-sim-pro-rel-alpha-010 present the results for the combination $(\rho, n_1, k)$ for $\alpha = 0.05$ and $\alpha = 0.10$. @fig-sim-pro-rel-alpha provides a visual representation of these results.
