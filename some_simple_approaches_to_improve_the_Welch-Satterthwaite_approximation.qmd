...
[^type-I-error-ws]: The index $j$ takes on values from $1$ to $396$ because $\rho$ takes $6$, $n_1$ $10$, $k$ $3$ and $\alpha$ $2$ values. Therefore $\widehat{\alpha}_j$ can take $360$ values.
